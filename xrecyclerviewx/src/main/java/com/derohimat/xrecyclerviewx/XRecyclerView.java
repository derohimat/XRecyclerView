...
import static com.derohimat.xrecyclerviewx.BaseRefreshHeader.STATE_DONE;

public class XRecyclerView extends RecyclerView {
    private static final float DRAG_RATE = 3;
    //ItemViewType(ReservedItemViewType),adapter 。ItemViewType 10000
    private static final int TYPE_REFRESH_HEADER = 10000;//adapter
    private static final int TYPE_FOOTER = 10001;
    private static final int HEADER_INIT_INDEX = 10002;
    private static List<Integer> sHeaderTypes = new ArrayList<>();// header type
